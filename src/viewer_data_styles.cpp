...
/**** GPLv3 License ******************************************************** 
** viewer_data_style.cpp is part of Spectral Viewer
**        
...
*/
std::vector<QString> StyleBuilder::getStyleID(DataFactory& data) const {
...
void StyleBuilder::loadStyle(DataFactory& data, const QString& style_id){
    ...
    this->fluormenu_background = style->value("fluormenu_background", "#FFFFFF").toString();
...
QString StyleBuilder::buildPushButton() const {
    ...
    style = "QPushButton {"
            ...
            " color: %4;"
            "} "
            "QPushButton::pressed::hover[Toggle=true] {"
            " background-color: %6;"
            " border-color: %7;"
            " color: %8;"
            "} "
            "QPushButton::hover[Toggle=true] {"
            " background-color: %9;"
            " border-color: %10;"
            " color: %11;"
            "} "
            "QPushButton[Toggle=false] {"
            " background-color: %12;"
            " border-color: %13;"
            " color: %14;"
            "} "
            "QPushButton::pressed::hover[Toggle=false] {"
            " background-color: %15;"
            " border-color: %16;"
            " color: %17;"
            "} "
            "QPushButton::hover[Toggle=false] {"
            " background-color: %18;"
            " border-color: %19;"
            " color: %20;"
            "} ";
...
/*
Builds the stylesheet for the tool_bar
    :returns: stylesheet
*/
QString StyleBuilder::buildToolBar() const {
    QString style;
    style = "BarIconPushButton[Toggle=true] {"
            " padding: 0px;"
            "} "
            "BarIconPushButton[Toggle=false] {"
            " padding: 0px;"
            "} ";
    return(style);
}
...
QString StyleBuilder::buildLaserMenu() const {
    ...
    style = "LaserPushButton {"
            ...
            " background: %1;"
            "} "
            "LaserPopup QScrollBar::vertical {"
...
QString StyleBuilder::buildFluorMenu() const {
    QString style;
    style = "MenuPushButton {"
            " min-width: 10em;"
            "} "
            "QPushButton#menu_excitation {"
            " padding: 6px 1px 6px 1px;"
            "} "
            "QPushButton#menu_remove {"
            " background-color: %1;"
            " padding: 6px 1px 6px 1px;"
            "} "
            "QPushButton#menu_remove:hover {"
            " background-color: %2;"
            "} "
            "QPushButton#menu_remove:pressed:hover {"
            " background-color: %3;"
            "} "
            "MenuLineEdit {"
            " max-height: 1em;"
            "} "
            "QListView#menu_popup .QWidget {"
            " background: %4;"
            "} "
            "QListView#menu_popup QScrollBar::vertical {"
            " margin: 0px 0px 0px 6px;"
            " width: 16px;"
            "} "
            "MenuScrollArea .QWidget {"
            " background: %5;"
            "} "
            "MenuScrollArea QScrollBar::vertical {"
            " margin: 0px 0px 0px 3px;"
            " width: 13px;"
            "} ";
...
QString StyleBuilder::buildGraph() const {
    QString style;
    style = "GraphScrollArea QWidget QLabel {"
            " background: %1;"
            " color: %2;"
            " font: %3;"
            "} "
            "GraphScrollArea .QWidget {"
            " background: %1;"
            "} "
            "GraphScrollArea QScrollBar::vertical {"
