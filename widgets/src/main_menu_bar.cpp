...
*/
void InstrumentMenu::receiveInstrument(QString id){
...
*/
void InstrumentMenu::receiveInstruments(const Data::InstrumentReader& data){
    this->buildMenu(data);
}
...
*/
void OptionsMenu::receiveStyle(const QString& id){
    this->selectStyle(id);
}
...
*/
void OptionsMenu::receiveStyles(const std::vector<Data::StyleID>& styles){
...
*/
void OptionsMenu::receiveSortMode(State::SortMode mode){
    this->selectSortMode(mode);
}
...
*/
void MenuBar::receiveMenuBarStateChange(Main::MenuBarAction action, const QVariant& id){
...
*/
void MenuBar::receiveInstruments(const Data::InstrumentReader& instruments){
...
*/
void MenuBar::receiveStyles(const std::vector<Data::StyleID>& styles){
