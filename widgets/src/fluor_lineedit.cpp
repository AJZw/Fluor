...
void LineEdit::setCompleter(QCompleter* completer) {
  ...
  if (this->_completer) {
    QObject::disconnect(this->completer(), QOverload<const QString&>::of(&QCompleter::highlighted), this,
                        &Fluor::LineEdit::updatePopupHighlighted);
    QObject::disconnect(this->completer(), QOverload<const QString&>::of(&QCompleter::activated), this,
                        &Fluor::LineEdit::updatePopupActivated);
    // QObject::disconnect(this, &LineEdit::highlightPopup, static_cast<Fluor::Completer*>(this->completer()),
    // &Fluor::Completer::updateHighlight);
    delete this->_completer;
  }

  this->_completer = completer;
  QObject::connect(this->completer(), QOverload<const QString&>::of(&QCompleter::highlighted), this,
                   &Fluor::LineEdit::updatePopupHighlighted);
  QObject::connect(this->completer(), QOverload<const QString&>::of(&QCompleter::activated), this, &Fluor::LineEdit::updatePopupActivated);
  // QObject::connect(this, &LineEdit::highlightPopup, static_cast<Fluor::Completer*>(this->completer()),
  // &Fluor::Completer::updateHighlight);
}
...
*/
Popup::Popup(QWidget* parent) : QListView(parent), margin_scrollbar(0), max_visible_items(50), max_size() {
...
*/
QString Popup::viewportMarginsScrollBar() const { return QString::number(this->margin_scrollbar, 'f', 0); }
...
*/
void Popup::hidingScrollBar() { this->setViewportMargins(0, 0, 0, 0); }

/*
Slot: Receives showing signal from the vertical scrollbar and adds scrollbar margin
*/
void Popup::showingScrollBar() { this->setViewportMargins(0, 0, this->margin_scrollbar, 0); }
...
Completer::Completer(QWidget* parent)
    : QCompleter(parent),
      ...
      // default_items({QString{"PE"}, QString{"APC"}, QString{"FITC"}, QString{"BUV395"}, QString{"BUV560"}, QString{"BUV737"},
      // QString{"BV410"}, QString{"BV650"}, QString{"BV735"}, QString{"BV785"}}),
      completion("") {
...
*/
const QString& Completer::getCompletion() const { return (this->completion); }
...
void Completer::setPopup(Fluor::Popup* popup) {
  ...
  if (this->widget_popup) {
    QObject::disconnect(this->popup(), &Fluor::Popup::activated, static_cast<Fluor::LineEdit*>(this->parent()),
                        &Fluor::LineEdit::updatePopupActivated);
    QObject::disconnect(this->popup(), &Fluor::Popup::highlighted, static_cast<Fluor::LineEdit*>(this->parent()),
                        &Fluor::LineEdit::updatePopupHighlighted);
    QObject::disconnect(this->popup(), &Fluor::Popup::dblClicked, static_cast<Fluor::LineEdit*>(this->parent()),
                        &Fluor::LineEdit::updatePopupDblClicked);
  ...
  QObject::connect(this->popup(), &Fluor::Popup::activated, static_cast<Fluor::LineEdit*>(this->parent()),
                   &Fluor::LineEdit::updatePopupActivated);
  QObject::connect(this->popup(), &Fluor::Popup::highlighted, static_cast<Fluor::LineEdit*>(this->parent()),
                   &Fluor::LineEdit::updatePopupHighlighted);
  QObject::connect(this->popup(), &Fluor::Popup::dblClicked, static_cast<Fluor::LineEdit*>(this->parent()),
                   &Fluor::LineEdit::updatePopupDblClicked);
}
...
Updates the popup max size parameter
  :param widget: (optional) the widget to base the popup size upon, or if not specified bases it upon the screen size
*/
void Completer::updatePopupRect(const QWidget* widget) { static_cast<Fluor::Popup*>(this->popup())->updateRect(widget); }
