...
** Copyright:  Copyright (C) 2023 - AJ Zwijnenburg
** License:    LGPLv3
***************************************************************************/
...
AbstractLabel::AbstractLabel(const QString& text, QGraphicsItem* parent)
    : QGraphicsSimpleTextItem(text, parent), item_margins(0, 0, 0, 0), minimum_width(0), minimum_height(0) {}
...
*/
const QMargins& AbstractLabel::margins() const { return this->item_margins; }

/*
Set font
  :param font: the new font
*/
void AbstractLabel::setFont(const QFont& font) { QGraphicsSimpleTextItem::setFont(font); }

/*
Set text
  :param text: the new text
*/
void AbstractLabel::setText(const QString& text) { QGraphicsSimpleTextItem::setText(text); }

/*
Getter for minimum width of the item.
  :returns: width in pixels
*/
int AbstractLabel::minimumWidth() const { return this->minimum_width; }

/*
Getter for minimum height of the item.
  :returns: height in pixels
*/
int AbstractLabel::minimumHeight() const { return this->minimum_height; }
...
Constructor: axis title for the x-axis
  ...
  :param parent: parent
*/
LabelX::LabelX(const QString& text, QGraphicsItem* parent) : Axis::AbstractLabel(text, parent) {
...
Constructor: axis title for the y-axis
  ...
  :param parent: parent
*/
LabelY::LabelY(const QString& text, QGraphicsItem* parent) : AbstractLabel(text, parent) {
...
Constructor: a simple line graphicsitem
  ...
  :param parent: parent
*/
GridLine::GridLine(double location, QGraphicsItem* parent) : QGraphicsLineItem(parent), line_location(location) {}

/*
Set location attribute
  :param location: value to update location to
*/
void GridLine::setLocation(double location) { this->line_location = location; }

/*
Get line location
  :returns: location
*/
double GridLine::location() const { return this->line_location; }

/*
Updates the pen used by the painter to the brush as build by the style
  :param style: brush factory
*/
void GridLine::updatePainter(const Graph::Format::Style* style) { this->setPen(style->penGrid()); }
...
AbstractGridLines::AbstractGridLines(QGraphicsItem* parent)
    : QGraphicsItem(parent), items(), style(nullptr), item_margins(0, 0, 0, 0), line_length(0), minimum_width(0), minimum_height(0) {}

/*
Container class - doesnt have its own content, so no bounding rectangle
  :returns: bounding rectangle
*/
QRectF AbstractGridLines::boundingRect() const { return QRectF(0.0, 0.0, 0.0, 0.0); }
...
Get margins
  :returns: margins of the item
*/
const QMargins& AbstractGridLines::margins() const { return this->item_margins; }

/*
Returns the minimum width of (one) ticks
  :returns int: width
*/
int AbstractGridLines::minimumWidth() const { return this->minimum_width; }

/*
Return the minimum height of the ticks
  :returns: height
*/
int AbstractGridLines::minimumHeight() const { return this->minimum_height; }
...
Constructor: holds a list of pointers to a list of QGraphicItems, constructs / destructs items if necessary
  :param scene: graphicsscene to add the items to. This is required, do NOT parse nullptr, items must be added to a scene for proper
lifetime handling
*/
TicksX::TicksX(QGraphicsItem* parent) : Axis::AbstractGridLines(parent) {
...
lifetime handling
*/
TicksY::TicksY(QGraphicsItem* parent) : Axis::AbstractGridLines(parent) {
...
lifetime handling
*/
GridLinesX::GridLinesX(QGraphicsItem* parent) : Axis::AbstractGridLines(parent) {
...
*/
void GridLinesX::calculateMinimumSize() { return; }
...
lifetime handling
*/
GridLinesY::GridLinesY(QGraphicsItem* parent) : Axis::AbstractGridLines(parent) {
...
Placeholder, doesnt do anything. Just here for completion sake, minimum size for lines doesnt really make sense...
*/
void GridLinesY::calculateMinimumSize() { return; }
...
Constructor: construct a label for a specific axis grid/tick location
  ...
  :param parent: parent
*/
GridLabel::GridLabel(double location, QString label, QGraphicsItem* parent) : QGraphicsSimpleTextItem(parent), label_location(location) {
  this->setText(label);
}
...
Set location attribute
  :param location: value to update location to
*/
void GridLabel::setLocation(double location) { this->label_location = location; }

/*
Get location
  :returns: location
*/
double GridLabel::location() const { return this->label_location; }
...
AbstractGridLabels::AbstractGridLabels(QGraphicsItem* parent)
    : QGraphicsItem(parent), items(), style(nullptr), item_margins(0, 0, 0, 0), space_offset(0), minimum_width(0), minimum_height(0) {}

/*
Container class, doesnt contain its own object, so bounding rectangle is empty
  :returns: empty QRectF
*/
QRectF AbstractGridLabels::boundingRect() const { return QRectF(0.0, 0.0, 0.0, 0.0); }
...
Get margins
  :returns: margins of the item
*/
const QMargins& AbstractGridLabels::margins() const { return this->item_margins; }

/*
Returns the minimum width of (one) ticks
  :returns int: width
*/
int AbstractGridLabels::minimumWidth() const { return this->minimum_width; }

/*
Return the minimum height of the ticks
  :returns: height
*/
int AbstractGridLabels::minimumHeight() const { return this->minimum_height; }
...
lifetime handling
*/
GridLabelsX::GridLabelsX(QGraphicsItem* parent) : Axis::AbstractGridLabels(parent) {
...
lifetime handling
*/
GridLabelsY::GridLabelsY(QGraphicsItem* parent) : AbstractGridLabels(parent) {
  this->setMargins(0, 0, 2, 0);
  this->space_offset = 3;
  this->setPos(0.0, 0.0);
}
...
Constructor: background of the actual graph area
  :param parent: parent
*/
Background::Background(QGraphicsItem* parent) : QGraphicsRectItem(parent), item_margins(1, 1, 1, 0), minimum_width(0), minimum_height(0) {
...
Get margins
  :returns: margins of the item
*/
const QMargins& Background::margins() const { return this->item_margins; }

/*
Getter for minimum width of the item.
  :returns: width in pixels
*/
int Background::minimumWidth() const { return this->minimum_width; }

/*
Getter for minimum height of the item.
  :returns: height in pixels
*/
int Background::minimumHeight() const { return this->minimum_height; }

/*
Sets the location of the item within the space allocated, assumes enough space to adhere to minimumWidth and Height
  :param space: the allocated space
*/
void Background::setPosition(const QRectF& space) { this->setRect(space.marginsRemoved(this->margins())); }

/*
Updates the brush used by the painter to the brush as build by the style
  :param style: brush factory
*/
void Background::updatePainter(const Graph::Format::Style* style) { this->setBrush(style->brushBackground()); }
...
Get margins
  :returns: margins of the item
*/
const QMargins& Outline::margins() const { return this->item_margins; }

/*
Getter for minimum width of the item.
  :returns: width in pixels
*/
int Outline::minimumWidth() const { return this->minimum_width; }

/*
Getter for minimum height of the item.
  :returns: height in pixels
*/
int Outline::minimumHeight() const { return this->minimum_height; }

/*
Sets the location of the item within the space allocated, assumes enough space to adhere to minimumWidth and Height
  :param space: the allocated space
*/
void Outline::setPosition(const QRectF& space) { this->setRect(space.marginsRemoved(this->margins())); }
...
*/
bool Outline::isHover() const { return this->is_hover; }
...
*/
bool Outline::isPressed() const { return this->is_pressed; }
...
Return the outline's pressed state
*/
bool Outline::isSelected() const { return this->is_selected; }
...
Get margins
  :returns: margins of the item
*/
const QMargins& Colorbar::margins() const { return this->item_margins; }

/*
Getter for minimum width of the item.
  :returns: width in pixels
*/
int Colorbar::minimumWidth() const { return this->minimum_width; }

/*
Getter for minimum height of the item.
  :returns: height in pixels
*/
int Colorbar::minimumHeight() const { return this->minimum_height; }
...
*/
bool Colorbar::isHover() const { return this->is_hover; }
...
*/
bool Colorbar::isPressed() const { return this->is_pressed; }
...
*/
bool Colorbar::isSelected() const { return this->is_selected; }
...
*/
double Spectrum::intensity() const { return this->intensity_coefficient; }

/*
Returns the bounding rectangle of the entire plotting region, might need to reconsider this one
  :returns: bounding rectangle
*/
QRectF Spectrum::boundingRect() const { return this->spectrum_space; }
...
void Spectrum::setPosition(const PlotRectF& space) {
  ...
  this->spectrum_excitation.scale(this->spectrum_source.spectrum().excitation(), plot_space, space.toLocalXFunction(),
                                  space.toLocalYFunction(), 1.0);
  ...
  this->spectrum_emission.scale(this->spectrum_source.spectrum().emission(), plot_space, space.toLocalXFunction(), space.toLocalYFunction(),
  ...
  if (this->spectrum_excitation.polygon().empty()) {
    ...
    left = std::min(this->spectrum_excitation.polygon()[0].x(), this->spectrum_emission.polygon()[0].x());
    right = std::max(this->spectrum_excitation.polygon()[this->spectrum_excitation.polygon().length() - 1].x(),
...
void Spectrum::updatePainter(const Graph::Format::Style* style) {
  if (this->spectrum_source.absorptionFlag()) {
    ...
    this->pen_excitation_select = style->penAbsorptionSelect(this->spectrum_emission.color());
  } else {
...
*/
Data::CacheSpectrum& Spectrum::source() const { return this->spectrum_source; }
...
Constructor: constructs a graphicsitem that represents a laser in the scene.
  ...
  :param parent: parent widget
*/
Laser::Laser(QGraphicsItem* parent) : QGraphicsLineItem(parent), laser_wavelength(0.0) { this->setPos(0.0, 0.0); }
...
Constructor: constructs a graphicsitem that represents a laser in the scene.
  ...
  :param parent: parent widget
*/
Laser::Laser(double wavelength, QGraphicsItem* parent) : QGraphicsLineItem(parent), laser_wavelength(wavelength) {}

/*
Setter: sets the wavelength of the laser
  :param wavelength: the wavelength to set
*/
void Laser::setWavelength(double wavelength) { this->laser_wavelength = wavelength; }

/*
Getter: gets the wavelength
  :returns: the wavelength of the laser
*/
double Laser::wavelength() const { return this->laser_wavelength; }
...
Filter::Filter(QGraphicsItem* parent)
    : QGraphicsItem(parent), wavelength_left(0.0), wavelength_right(0.0), item_left(), item_right(), item_top(), filter_space() {
...
Returns the bounding rectangle of the entire plotting region
  :returns: bounding rectangle
*/
QRectF Filter::boundingRect() const { return this->filter_space; }
...
void Filter::setPosition(const PlotRectF& space) {
  ...
  if (space.local() != this->filter_space) {
    this->filter_space = space.local();
    this->prepareGeometryChange();
  }
  ...
  // Get boundaries and correct for extreme inputs generated by shortpass and longpass filters
  double left = space.local().left();
  if (this->wavelength_left != 0.0) {
    left = space.toLocalX(this->wavelength_left);
  }

  double right = space.local().right();
  if (this->wavelength_right != std::numeric_limits<double>::max()) {
    right = space.toLocalX(this->wavelength_right);
  }
...
*/
double Filter::wavelengthLeft() const { return this->wavelength_left; }

/*
Return the wavelenght of the right (maximum) most wavelength
*/
double Filter::wavelengthRight() const { return this->wavelength_right; }
...
AbstractCollection<ITEM>::AbstractCollection(const PlotRectF& rect, QGraphicsItem* scene)
    : QGraphicsItem(scene), items(), style(nullptr), items_space(rect), minimum_width(0), minimum_height(0) {
...
Constructor: container for the spectrum widgets. Handles mainly the adding and removing of the spectra.
  :param parent: parent widget
*/
SpectrumCollection::SpectrumCollection(const PlotRectF& rect, QGraphicsItem* parent) : AbstractCollection(rect, parent) {
...
void SpectrumCollection::syncSpectra(const std::vector<Cache::ID>& cache_state) {
  ...
  for (const Cache::ID& id : cache_state) {
    ...
    if (index_item >= this->items.size()) {
      ...
      this->items.insert(std::next(this->items.begin(), static_cast<int>(index_current)), item_new);
    } else if (index_item == index_current) {
      // Pass, already sorted
    } else {
      // item was found - rotate into position
      std::size_t index_next = index_item + 1;
      std::rotate(std::next(this->items.begin(), static_cast<int>(index_current)),
  ...
  if (this->items.size() != index_current) {
    ...
    // Delete pointers
    this->items.erase(std::next(this->items.begin(), static_cast<int>(index_current)), this->items.cend());
  }
}
...
Constructor: container for Laser widgets. This mainly handles the adding and removing of the Lasers.
  ...
  :param parent: parent widget
*/
LaserCollection::LaserCollection(const PlotRectF& rect, QGraphicsItem* parent) : AbstractCollection(rect, parent) {
...
void LaserCollection::syncLasers(const std::vector<Data::Laser>& lasers) {
  ...
  if (this->items.size() < lasers.size()) {
    ...
    this->items.erase(std::next(this->items.begin(), static_cast<int>(lasers.size())), this->items.cend());
  }
...
Constructor: container for the Detector widgets. This mainly handles the adding and removing of detectors.
  ...
  :param parent: parent widget
*/
FilterCollection::FilterCollection(const PlotRectF& rect, QGraphicsItem* parent) : AbstractCollection(rect, parent) {
...
void FilterCollection::syncFilters(const std::vector<Data::Filter>& filters) {
  ...
  if (this->items.size() < filters.size()) {
    ...
    this->items.erase(std::next(this->items.begin(), static_cast<int>(filters.size())), this->items.cend());
  }
  ...
  for (std::size_t i = 0; i < this->items.size(); ++i) {
    ...
    // Set correct bevels for SP, LP filters
    switch (filters[i].type()) {
      case Data::Filter::LongPass: {
        this->items[i]->setBevel(Filter::BevelShape::Round, Filter::BevelShape::Square);
        break;
      }
      case Data::Filter::ShortPass: {
        this->items[i]->setBevel(Filter::BevelShape::Square, Filter::BevelShape::Round);
        break;
      }
      default: {
        this->items[i]->setBevel(Filter::BevelShape::Round, Filter::BevelShape::Round);
        break;
      }
    }
