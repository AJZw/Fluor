...
void Program::retreiveGUIPosition() {
  ...
  this->gui.move(window_x + QApplication::style()->pixelMetric(QStyle::PM_DefaultFrameWidth),
                 window_y + QApplication::style()->pixelMetric(QStyle::PM_TitleBarHeight));
...
*/
void Program::syncGraphs() { emit this->sendGraphState(this->state_gui.graphs()); }
...
*/
void Program::syncFluorophores() { emit this->sendFluorophores(this->data_fluorophores); }
...
*/
void Program::syncInstruments() { emit this->sendInstruments(this->data_instruments); }

/*
Synchronizes the style to the GUI (needed for options->styles menu)
*/
void Program::syncStyle() { emit this->sendMenuBarState(Main::MenuBarAction::StyleID, this->style.id()); }
...
*/
void Program::receiveCacheRequestSync() { emit this->sendCacheState(this->cache.state()); }

/*
Slot: receives a Cache request update signal, forces GUI update
*/
void Program::receiveCacheRequestUpdate() { emit this->sendCacheUpdate(); }
