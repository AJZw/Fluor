...
struct Ticks {
  Ticks(std::array<Format::Tick, TICK_COUNT> const& ticks) : valid(false), index_begin(0), index_end(0), ticks(ticks){};
...
struct Settings {
  ...
  Ticks<31> x_ticks = {{Format::Tick(0, "0"),       Format::Tick(50),   Format::Tick(100, "100"),   Format::Tick(150),
                        Format::Tick(200, "200"),   Format::Tick(250),  Format::Tick(300, "300"),   Format::Tick(350),
                        Format::Tick(400, "400"),   Format::Tick(450),  Format::Tick(500, "500"),   Format::Tick(550),
                        Format::Tick(600, "600"),   Format::Tick(650),  Format::Tick(700, "700"),   Format::Tick(750),
                        Format::Tick(800, "800"),   Format::Tick(850),  Format::Tick(900, "900"),   Format::Tick(950),
                        Format::Tick(1000, "1000"), Format::Tick(1050), Format::Tick(1100, "1100"), Format::Tick(1150),
                        Format::Tick(1200, "1200"), Format::Tick(1250), Format::Tick(1300, "1300"), Format::Tick(1350),
                        Format::Tick(1400, "1400"), Format::Tick(1450), Format::Tick(1500, "1500")}};

  const Axis y_axis = Format::Axis(400, 0, QString("Intensity (%)"));
  AxisRange y_range = Format::AxisRange(100, 0);
  Ticks<21> y_ticks = {{Format::Tick(400, "400"), Format::Tick(380, "380"), Format::Tick(360, "360"), Format::Tick(340, "340"),
                        Format::Tick(320, "320"), Format::Tick(300, "300"), Format::Tick(280, "280"), Format::Tick(260, "260"),
                        Format::Tick(240, "240"), Format::Tick(220, "220"), Format::Tick(200, "200"), Format::Tick(180, "180"),
                        Format::Tick(160, "160"), Format::Tick(140, "140"), Format::Tick(120, "120"), Format::Tick(100, "100"),
                        Format::Tick(80, "80"),   Format::Tick(60, "60"),   Format::Tick(40, "40"),   Format::Tick(20, "20"),
                        Format::Tick(0, "0")}};
