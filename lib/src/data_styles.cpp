...
*/
QString StyleBuilder::id() const { return this->style_id; }

/*
Getter: returns the QSS stylesheet
  :returns: stylesheet
*/
QString StyleBuilder::getStyleSheet() const { return (this->stylesheet); }
...
QString StyleBuilder::buildLayout(const QFontMetrics& metrics) const {
  ...
  style =
      ...
      " qproperty-layout_spacing: %2;"
      "} ";
  style = style.arg(StyleBuilder::toPixels(metrics, this->layout_margins), StyleBuilder::toPixels(metrics, this->layout_spacing));
  return style;
}
...
QString StyleBuilder::buildLabel(const QFontMetrics& metrics) const {
  ...
  style =
      ...
      " font-weight: normal;"
      "} ";
  style = style.arg(this->label_text, this->label_text_weight, this->label_disabled_text, StyleBuilder::toPixels(metrics, "2em"),
                    StyleBuilder::toPixels(metrics, "0.67em"), StyleBuilder::toPixels(metrics, "1.5em"),
...
QString StyleBuilder::buildPushButton() const {
  ...
  style = style.arg(this->pushbutton_background, this->pushbutton_border_width, this->pushbutton_border, this->pushbutton_text,
                    this->pushbutton_text_weight, this->pushbutton_press_background, this->pushbutton_press_border,
                    this->pushbutton_press_text);
  style =
      style.arg(this->pushbutton_hover_background, this->pushbutton_hover_border, this->pushbutton_hover_text,
                this->pushbutton_inactive_background, this->pushbutton_inactive_border, this->pushbutton_inactive_text,
                this->pushbutton_inactive_press_background, this->pushbutton_inactive_press_border, this->pushbutton_inactive_press_text);
  style =
      style.arg(this->pushbutton_inactive_hover_background, this->pushbutton_inactive_hover_border, this->pushbutton_inactive_hover_text,
                this->pushbutton_disabled_background, this->pushbutton_disabled_border, this->pushbutton_disabled_text);
...
QString StyleBuilder::buildLineEdit() const {
  ...
  style = style.arg(this->lineedit_background, this->lineedit_text, this->lineedit_text_weight, this->lineedit_selection,
                    this->lineedit_selection_text, this->lineedit_border, this->lineedit_border_width);
  style = style.arg(this->lineedit_hover, this->lineedit_hover_text, this->lineedit_hover_border, this->lineedit_popup,
                    this->lineedit_popup_text, this->lineedit_popup_border, this->lineedit_popup_hover, this->lineedit_popup_hover_text,
...
QString StyleBuilder::buildListView() const {
  ...
  style = style.arg(this->listview_background, this->listview_text, this->listview_text_weight, this->listview_border,
                    this->listview_border_width);
  style = style.arg(this->listview_item, this->listview_item_text, this->listview_item_hover, this->listview_item_hover_text,
                    this->listview_item_selection, this->listview_item_selection_text, this->listview_item_disable,
...
QString StyleBuilder::buildScrollBar() const {
  ...
  style = style.arg(this->scrollbar_border_width, this->scrollbar_border, this->scrollbar_handle, this->scrollbar_background,
...
QString StyleBuilder::buildToolBar(const QFontMetrics& metrics) const {
  ...
  style =
      ...
      " min-width: 10em;"
      "} ";
  style = style.arg(StyleBuilder::toPixels(metrics, this->layout_spacing), StyleBuilder::toPixels(metrics, "1eh+8px"), this->icons);
  return (style);
}
...
QString StyleBuilder::buildLaserMenu(const QFontMetrics& metrics) const {
  ...
  style =
      style.arg(StyleBuilder::toPixels(metrics, "15em"), StyleBuilder::toPixels(metrics, "1eh"),
                StyleBuilder::toPixels(metrics, this->layout_sub_spacing), this->lasermenu_popup, StyleBuilder::toPixels(metrics, "0.5em"),
                StyleBuilder::toPixels(metrics, this->layout_spacing), this->listview_border, this->listview_border_width);
...
QString StyleBuilder::buildFluorMenu(const QFontMetrics& metrics) const {
  ...
  style =
      ...
      "} ";
  style =
      style.arg(StyleBuilder::toPixels(metrics, this->layout_spacing), StyleBuilder::toPixels(metrics, this->layout_sub_spacing),
                StyleBuilder::toPixels(metrics, "23em"), this->pushbutton_hover_background, this->pushbutton_hover_border,
                this->pushbutton_hover_text, this->pushbutton_press_background, this->pushbutton_press_border, this->pushbutton_press_text);
  style =
      style.arg(this->pushbutton_inactive_hover_background, this->pushbutton_inactive_hover_border, this->pushbutton_inactive_hover_text,
                this->pushbutton_inactive_press_background, this->pushbutton_inactive_press_border, this->pushbutton_inactive_press_text,
                this->fluormenu_remove, this->fluormenu_remove_hover, this->fluormenu_remove_press);
  style = style.arg(StyleBuilder::toPixels(metrics, "1eh"), this->fluormenu_popup, this->fluormenu_background,
...
QString StyleBuilder::buildGraph(const QFontMetrics& metrics) const {
  ...
  style =
      ...
      "} ";
  style = style.arg(StyleBuilder::toPixels(metrics, this->layout_spacing), StyleBuilder::toPixels(metrics, this->layout_sub_spacing),
                    this->background, StyleBuilder::toPixels(metrics, "0.5em"), this->graph_scene, this->graph_background,
                    this->graph_background_hover, this->graph_background_press);
  style = style.arg(this->graph_axis, this->graph_axis_hover, this->graph_axis_press, this->graph_label, this->graph_label_weight,
                    this->graph_grid, this->graph_grid_label, this->graph_grid_label_weight);
  style = style.arg(this->graph_filter, StyleBuilder::toPixels(metrics, this->graph_filter_width),
                    StyleBuilder::toPixels(metrics, this->graph_absorption_width), this->graph_absorption_style,
                    StyleBuilder::toPixels(metrics, this->graph_excitation_width), this->graph_excitation_style,
                    StyleBuilder::toPixels(metrics, this->graph_emission_width), this->graph_emission_style,
...
QString StyleBuilder::buildAboutWindow(const QFontMetrics& metrics) const {
  ...
  style =
      ...
      " qproperty-scale: %3;"
      "} ";
  style = style.arg(this->background, this->icons, StyleBuilder::toPixels(metrics, "12eh"));
  return style;
}
