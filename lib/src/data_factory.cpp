...
*/
Factory::Factory(const QString settings, const QString styles, const QString instruments, const QString fluorophores)
...
*/
bool Factory::isValid() const { return !this->error_fatal; }
...
*/
bool Factory::isWarning() const { return this->error_warning; }
...
*/
QString Factory::getPathSettings() const { return this->path_settings; }

/*
Getter for path_defaults
  :returns: absolute path to the default settings source file
*/
QString Factory::getPathDefaults() const { return this->path_defaults; }

/*
Getter for path_styles
  :returns: absolute path to the styles source file
*/
QString Factory::getPathStyles() const { return this->path_styles; }

/*
Getter for path_cytometers
  :returns: absolute path to the cytometers source file
*/
QString Factory::getPathInstruments() const { return this->path_instruments; }

/*
Getter for path_fluorophores
  :returns: absolute path to the fluorophores source file
*/
QString Factory::getPathFluorophores() const { return this->path_fluorophores; }
