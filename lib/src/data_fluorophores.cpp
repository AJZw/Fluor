...
void FluorophoreReader::load(Data::Factory& factory){
    ...
    std::size_t multi_size = data_size /4; // A guess, depends on amount of alternative names, if vector/unordered_map is too small, will auto grow anyway
